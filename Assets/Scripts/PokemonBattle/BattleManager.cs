...
namespace pokemonBattle
{
    public class BattleManager : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            attacksPanel = actionsPanel.Find("AttacksPanel").gameObject;
            attackDescriptionPanel = actionsPanel.Find("AttacksDescriptionPanel").gameObject;
        }
